...
def _dump_observed_results(
    ...
    dump_result_objects(
        ...
        file_name=Path(config.pickle_file_prefix.observed_data + "_depth_surfaces.pkl"),
        output_obj=depth_surfaces,
    )
    dump_result_objects(
        output_path=config.paths.pickle_file_output_dir,
        file_name=Path(config.pickle_file_prefix.observed_data + "_time_surfaces.pkl"),
        output_obj=time_surfaces,
    )
    dump_result_objects(
        output_path=config.paths.pickle_file_output_dir,
        file_name=Path(config.pickle_file_prefix.observed_data + "_depth_cubes.pkl"),
        output_obj=depth_cubes,
    )
    dump_result_objects(
        output_path=config.paths.pickle_file_output_dir,
        file_name=Path(config.pickle_file_prefix.observed_data + "_time_cubes.pkl"),
    ...
    if attributes:
        dump_result_objects(
            output_path=config.paths.pickle_file_output_dir,
            file_name=Path(
                config.pickle_file_prefix.observed_data + "_depth_attributes.pkl"
            ),
