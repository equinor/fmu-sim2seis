...
> # file is given as a relative path from the FMU top directory
> pem --help
...
> sim2seis_observed_data -f ./sim2seis/model/sim2seis_combined_config.yml -g fmuconfig/output/global_variables.yml -o HIST -v true
>
...
> sim2seis_seismic_forward -f ./sim2seis/model/sim2seis_combined_config.yml -g fmuconfig/output/global_variables.yml -m HIST -v true
>
