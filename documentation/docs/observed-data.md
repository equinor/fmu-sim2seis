...
```shell
# Normal run
> sim2seis_observed_data -c <config_dir> -f <config_file>
>
# Run with verbose output
> sim2seis_observed_data -c <config_dir> -f <config_file> -v true
>
# Run without generating attributes - depth conversion only
> sim2seis_observed_data -c <config_dir> -f <config_file> -n true
```
...
FORWARD_MODEL OBSERVED_DATA(<CONFIG_DIR>=<RELPATH_CONFIG_FILES>, <CONFIG_FILE>=<OBS_DATA_CONFIG>, <VERBOSE>=<VERBOSE_OUTPUT>)
```
