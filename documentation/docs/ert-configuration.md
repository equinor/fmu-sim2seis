...
FORWARD_MODEL MAP_ATTRIBUTES(<CONFIG_FILE>=<SIM2SEIS_CONFIG_FILE>, <GLOBAL_FILE>=<GLOBAL_CONFIG_FILE>, <ATTRIBUTE>=amplitude)

FORWARD_MODEL MAP_ATTRIBUTES(<CONFIG_FILE>=<SIM2SEIS_CONFIG_FILE>, <GLOBAL_FILE>=<GLOBAL_CONFIG_FILE>, <ATTRIBUTE>=relai)
