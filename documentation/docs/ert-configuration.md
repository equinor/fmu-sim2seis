...
FORWARD_MODEL RELATIVE_INVERSION(<CONFIG_FILE>=<SIM2SEIS_CONFIG_FILE>, <GLOBAL_FILE>=<GLOBAL_CONFIG_FILE>, <VERBOSE>=<VERBOSE_OUTPUT>)

FORWARD_MODEL MAP_ATTRIBUTES(<CONFIG_FILE>=<SIM2SEIS_CONFIG_FILE>, <GLOBAL_FILE>=<GLOBAL_CONFIG_FILE>, <ATTRIBUTE>=amplitude, <VERBOSE>=<VERBOSE_OUTPUT>)

FORWARD_MODEL MAP_ATTRIBUTES(<CONFIG_FILE>=<SIM2SEIS_CONFIG_FILE>, <GLOBAL_FILE>=<GLOBAL_CONFIG_FILE>, <ATTRIBUTE>=relai, <VERBOSE>=<VERBOSE_OUTPUT>)
