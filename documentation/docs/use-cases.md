...
> sim2seis_observed_data -c ./sim2seis/model -f sim2seis_config.yml -g ../../fmuconfig/output -o global_variables.yml -p HIST
>
...
> sim2seis_map_attributes -c ./sim2seis/model -f sim2seis_config.yml -g ../../fmuconfig/output -o global_variables.yml -a relai
>
...
> sim2seis_cleanup -c ./sim2seis/model -f sim2seis_config.yml -l relai
```
